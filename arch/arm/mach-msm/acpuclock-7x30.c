...
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
	...
	{ 0, 122880, PLL_3,    5, 5,  61440000,  775, VDD_RAW(775) },
	{ 0, 184320, PLL_3,    5, 4,  61440000,  775, VDD_RAW(775) },
	{ 0, MAX_AXI_KHZ, AXI, 1, 0,  61440000,  725, VDD_RAW(725) },
	{ 1, 149760, PLL_3,    5, 2,  61440000,  725, VDD_RAW(725) },
	{ 1, 245760, PLL_3,    5, 1,  122800000, 750, VDD_RAW(750) },
	{ 1, 341640, PLL_3,    5, 1,  122800000, 800, VDD_RAW(800) },
	{ 1, 614400, PLL_1,    2, 0,  153600000, 900, VDD_RAW(900) },
	{ 1, 768000,  PLL_2, 3, 0, 192000000, 950, VDD_RAW(950), &pll2_tbl[0]},
	{ 1, 806400,  PLL_2, 3, 0, 192000000, 1000, VDD_RAW(1000), &pll2_tbl[1]},
	{ 1, 1024000, PLL_2, 3, 0, 192000000, 1100, VDD_RAW(1100), &pll2_tbl[2]},
	{ 1, 1200000, PLL_2, 3, 0, 192000000, 1100, VDD_RAW(1100), &pll2_tbl[3]},
	{ 1, 1305600, PLL_2, 3, 0, 192000000, 1175, VDD_RAW(1175), &pll2_tbl[4]},
	{ 1, 1401600, PLL_2, 3, 0, 192000000, 1200, VDD_RAW(1200), &pll2_tbl[5]},
	{ 1, 1516800, PLL_2, 3, 0, 192000000, 1225, VDD_RAW(1225), &pll2_tbl[6]},
#ifdef CONFIG_JESUS_PHONE
	{ 1, 1612800, PLL_2, 3, 0, 192000000, 1250, VDD_RAW(1250), &pll2_tbl[6]},
	{ 1, 1689600, PLL_2, 3, 0, 192000000, 1300, VDD_RAW(1300), &pll2_tbl[6]},
	{ 1, 1766400, PLL_2, 3, 0, 192000000, 1375, VDD_RAW(1375), &pll2_tbl[6]},
